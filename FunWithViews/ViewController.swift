...
class ViewController: UIViewController {
    ...
    //Update the label text according to the diceroll number
    ...
    //If there are six rolls, then reset it back
    func resetRolls(){
        
        if label1.isHidden == false && label2.isHidden == false && label3.isHidden == false && label4.isHidden == false && label5.isHidden == false && label6.isHidden == false{
